...
public class GeneratePDF extends JPanel {
	...
	public void generatePDF(String cnp) {
		...
		System.out.println("Debug: dateInceput:"+dateInceput.toString());
		System.out.println("Debug: dataSfarsit:"+dateSfarsit.toString());
		if(result<0){
			...
			JOptionPane.showMessageDialog(null, "Date incepu mai mare decat data sfarsit");
		}
