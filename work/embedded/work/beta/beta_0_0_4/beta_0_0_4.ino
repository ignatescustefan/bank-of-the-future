...
{
  String authCode="";
  long alpha_or_numeric=-1;
  long random_char=-1;
  for(int i=0;i<32;++i)
  {
    alpha_or_numeric=random(0,2);
    switch(alpha_or_numeric)
    {
      case 0:
        random_char=random(97,122);
        break;
      case 1:
        random_char=random(48,57);
        break;
      case 2:
        random_char=random(65,90);
        break;
    }
    authCode.concat(String((char)(random_char)));
  }
  return authCode;
}
...
void Execute_State_11()
{
  ...
  unsigned battery_procent=(adc_read*300*112)/102400;
  lcd.clear();
  LCD_print(1,0,"Despre dispozitiv:");
  LCD_print(3,1,"RIPBankC Token");
  LCD_print(5,2,"v0.3 alpha");
  LCD_print(4,3,adc_value+"Baterie:"+battery_procent+"%");
  delay(2500);
  Execute_State_10();
}
...
void Execute_State_15()
{
  ...
  String message_to_send=generateAuthCode();
  State=15;
  short int cnt=0;
  lcd.clear();
  delay(150);
...
void setup()
{
  ...
  keypad.setHoldTime(100);               // Default is 100ms
